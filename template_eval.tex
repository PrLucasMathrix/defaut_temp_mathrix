...
\usepackage{colortbl}
\usepackage[T1]{fontenc}
%\usepackage{draftwatermark} %à activer lors de l'envois en relecture/correction.
\usepackage[utf8]{inputenc}
\usepackage{fourier}
...
%Spécimen
%à activer lors de l'envois en relecture/correction.

%\SetWatermarkText{\textsc{Spécimen}}
